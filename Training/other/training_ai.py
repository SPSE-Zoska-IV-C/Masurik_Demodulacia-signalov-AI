...
def compute_bit_accuracy(preds, targets):
    ...
    rounded = torch.round(preds)          # 0.0 or 1.0
...
def train_model(
    train_dir,
    val_dir=None,          # Pass a separate validation directory, or None to split from train
    ...
    print("Model saved to ANN_radio_model_32bit.pth")
